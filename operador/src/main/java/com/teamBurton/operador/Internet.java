...
public class Internet extends Internet_ventana implements View{
	...
	public void cargar_modalidades_internet()
	{
		...
		{
			modalidades = cibernauta.cargar_modalidades_internet();
			
		}else if(((NavigatorUI) UI.getCurrent()).getParentView().equals("Comercial"))
		{
			modalidades = comercial.cargar_modalidades_internet();
		
		}else if(((NavigatorUI) UI.getCurrent()).getMainView().equals("Cliente"))
		{
			modalidades = cliente.cargar_modalidades_internet();
			
		}else
		{
			modalidades = administrador.cargar_modalidades_internet();
		}
