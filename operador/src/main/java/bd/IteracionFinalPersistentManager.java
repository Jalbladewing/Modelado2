...
public class IteracionFinalPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "IteracionFinal";
	...
	private IteracionFinalPersistentManager() throws PersistentException {
	...
	public Configuration createConfiguration() {
		...
		configuration.addAnnotatedClass(bd.Factura.class);
		configuration.addAnnotatedClass(bd.Modalidad.class);
		configuration.addAnnotatedClass(bd.Television.class);
		configuration.addAnnotatedClass(bd.Canal.class);
		configuration.addAnnotatedClass(bd.Incidencia.class);
		configuration.addAnnotatedClass(bd.Usuario.class);
		configuration.addAnnotatedClass(bd.Incidencia_administrador.class);
		configuration.addAnnotatedClass(bd.Cliente.class);
		configuration.addAnnotatedClass(bd.Movil.class);
		configuration.addAnnotatedClass(bd.Oferta.class);
		configuration.addAnnotatedClass(bd.contrato.class);
		configuration.addAnnotatedClass(bd.Comercial.class);
		configuration.addAnnotatedClass(bd.Administrador.class);
		configuration.addAnnotatedClass(bd.Paquete.class);
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new IteracionFinalPersistentManager();
		}
