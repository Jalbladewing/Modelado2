...
public class ModalidadDetachedCriteria extends AbstractORMDetachedCriteria {
	...
	public ModalidadDetachedCriteria() {
		super(bd.Modalidad.class, bd.ModalidadCriteria.class);
	...
	public ModalidadDetachedCriteria(DetachedCriteria aDetachedCriteria) {
		super(aDetachedCriteria, bd.ModalidadCriteria.class);
		ID = new IntegerExpression("ID", this.getDetachedCriteria());
		administradorId = new IntegerExpression("administrador.", this.getDetachedCriteria());
		administrador = new AssociationExpression("administrador", this.getDetachedCriteria());
		nombre = new StringExpression("nombre", this.getDetachedCriteria());
	...
	public Modalidad uniqueModalidad(PersistentSession session) {
		return (Modalidad) super.createExecutableCriteria(session).uniqueResult();
	}
	
	public Modalidad[] listModalidad(PersistentSession session) {
